...
(function ()
{
    ...
    function apiProvider()
    {
        ...
        this.$get = function ($log, $q, $resource, $rootScope)
        {
             ...
             */
            function resolve(action, parameters, customHeaders)
            {
                // Emit an event
                ...
                else
                {
                	...
                	var actions = {};
                	if (customHeaders) {
                		angular.copy(apiObject.actions, actions);
						
                		if (actions[method]) {
                			actions[method].headers = customHeaders;
						} else {
							actions[method] = {
                    ...
                    var resourceObject = $resource(baseUrl + apiObject.url, apiObject.paramDefaults, actions, apiObject.options);
            ...
            function request(action, parameters, success, error)
            {
                ...
                {
                    // Generate the $resource object based on the stored API object
                    var resourceObject = $resource(baseUrl + apiObject.url, apiObject.paramDefaults, apiObject.actions, apiObject.options);
